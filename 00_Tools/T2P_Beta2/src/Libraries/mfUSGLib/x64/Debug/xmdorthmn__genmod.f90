        ...
        MODULE XMDORTHMN__genmod
          INTERFACE 
            SUBROUTINE XMDORTHMN(A,B,X,AF,SOLN,CTOL,RRCTOL,IA,JA,IAF,JAF&
     &,IDIAGF,RBORDER,NBLACK,NRED,N,NJA,NJAF,NORTH,NITMAX,IERR)
              INTEGER(KIND=4) :: NJAF
              INTEGER(KIND=4) :: NJA
              INTEGER(KIND=4) :: N
