        ...
        MODULE XMDCNJGD__genmod
          INTERFACE 
            SUBROUTINE XMDCNJGD(A,B,X,AF,SOLN,CTOL,RRCTOL,IA,JA,IAF,JAF,&
     &IDIAGF,RBORDER,NBLACK,NRED,N,NJA,NJAF,NITMAX,IERR)
              INTEGER(KIND=4) :: NJAF
              INTEGER(KIND=4) :: NJA
              INTEGER(KIND=4) :: N
